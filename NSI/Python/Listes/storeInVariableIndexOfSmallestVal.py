...
def smallestValueInListIndexIdentifierWithMin(vallist:list):
    return vallist.index(min(vallist))
'''
...
def menu():
    ...
    if selectedFunction == "1":
        ...
        print("L'index de la plus petite valeur (avec min() en méthode) est: ", result)
    elif selectedFunction == "2":
        result = smallestValueInListIndexIdentifierWithLoop(list)
        print("L'index de la plus petite valeur en utilisant une boucle, est: ", result)
